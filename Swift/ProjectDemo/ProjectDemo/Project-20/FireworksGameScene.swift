...
class FireworksGameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        gameTimer = Timer.scheduledTimer(withTimeInterval: 6, repeats: true, block: launchFireworks)
    }
    ...
    private func launchFireworks(_ timer: Timer) {
